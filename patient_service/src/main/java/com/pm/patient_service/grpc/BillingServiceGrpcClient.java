...
//
//        String sanitizedHost = serverAddress.trim();
//        log.info("Resolved GRPC host='{}' (length={})", sanitizedHost, sanitizedHost.length());
//        for (char c : sanitizedHost.toCharArray()) {
//            log.info("Char [{}] = {}", (int)c, c);
//        }
//
//        ManagedChannel channel = ManagedChannelBuilder
//                .forAddress(sanitizedHost, serverPort)
//                .usePlaintext()
//                .build();
